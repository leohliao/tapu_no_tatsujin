...
import { TaikoBlue, TaikoRed, TaikoGold, FireworkGradients,
        hitMessages, missMessages } from './tap';
...
class Game {
  ...
  play(){
    ...
    this.redInt = setInterval( function () { this.createRedTaps(100);}.bind(this), 1000 );
  ...
  tapRed() {
    ...
    if (this.currentRowMid[0] &&
        this.currentRowMid[0].y > 512 &&
        this.currentRowMid[0].y < 538) {
          console.log("Mid:HIT");
  ...
  tapBlueLeft() {
    ...
    if (this.currentRowLeft[0] &&
        this.currentRowLeft[0].y > 512 &&
        this.currentRowLeft[0].y < 538) {
  ...
  tapBlueRight() {
    ...
    if (this.currentRowRight[0] &&
        this.currentRowRight[0].y > 512 &&
        this.currentRowRight[0].y < 538) {
